...
/*if (!empty($LocationID)) {
    ...
    if ($result = $conn->query("select * from Location where LocationID = $LocationID")) {
        //for debugging
        ...
        if($result->num_rows < 1) {
            ...
            echo "<tr><td>LocationID</td><td>State</td><td>County</td><td>City</td><td>LocationType</td></tr>";
        ...
        echo "Call to CalcAllPercentages failed<br>";
    }
} else {
